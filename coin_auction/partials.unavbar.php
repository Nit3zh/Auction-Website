    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <div class="container-fluid">
            ...
            <!-- Logo Starts -->
            <a class="navbar-brand" href="./uindex.php">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="./uindex.php">Home</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="nav-item dropdown getin">
                    ...
                    <ul class="dropdown-menu">
                        <li name="regUser"><a class="dropdown-item ureg-btn" href="./logout.php">Logout</a></li>
                    </ul>
                </div>
